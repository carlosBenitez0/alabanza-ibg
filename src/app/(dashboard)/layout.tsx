...
import { LayoutDashboard, Calendar, Users, Settings, LogOut, Menu, X, Bell, Shield } from 'lucide-react'
      ...
      >
        <div className="flex h-16 items-center justify-between px-4 border-b border-border">
          <Link href="/dashboard" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-primary hidden sm:block">Alabanza IBG</span>
          </Link>
          <button
        ...
        <div className="p-4 border-t border-border">
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-muted-foreground capitalize">{profile?.role || 'singer'}</p>
            </div>
          </div>
          <Button
            variant="ghost"
          ...
          <div className="flex h-full items-center justify-between px-4">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-secondary rounded-full text-sm">
                ...
                <span className="font-medium capitalize">{profile?.role || 'singer'}</span>
              </div>
            </div>
          </div>
        </header>
